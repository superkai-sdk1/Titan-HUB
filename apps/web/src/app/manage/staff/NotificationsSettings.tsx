...
import { Toggle, INP } from '@/components/manage/DesignSystem'
...
// Настройки уведомлений ТЕКУЩЕГО пользователя — секция внутри «Мой профиль».
export function NotificationsSettings() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div>
        <h3 style={{ margin: '0 0 6px', fontSize: 15, fontWeight: 700, color: 'var(--on-surface)', padding: '0 4px' }}>
          Какие уведомления получать
        </h3>
        <p style={{ fontSize: 12, color: 'var(--on-surface-variant)', margin: '0 4px 14px', lineHeight: 1.5 }}>
